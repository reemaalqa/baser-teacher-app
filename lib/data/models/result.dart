...
class Result {
  ...
  Result.fromJson(Map<String, dynamic> json) {
    resultId = int.parse((json['result']['result_id'] ?? 0).toString());
    ...
    sessionYear = (json['result']['session_year'] ?? 0).toString();
    totalMark =int.parse(( json['result']['total_marks'] ?? 0).toString());
    obtainedMark = json['result']['obtained_marks'] ?? 0.0;
